    ...
    <body>
        <div id="wrapper" class="toggled">
            ...
            <div id="page-content-wrapper">
                <div class="container-fluid" ng-controller="SvrManagerCrtl" ng-init="loadRecords()">
                        ...
                        <div class="col-md-12" ng-show="entryMode===1">
                            <form>
                                ...
                                <div class="input-group">
                                    ...
                                    <input id="configname" type="text" class="form-control" ng-model="record.SERVER_NAME" placeholder="SERVER01">
                                </div>
                                <div class="input-group">
                                    <span class="input-group-addon">SVR ADDRESS</span>
                                    <input id="dburl" type="text" class="form-control" ng-model="record.SERVER_ADDRESS" placeholder="http://localhost:8080/sync-app/syn/load-data">
                                </div>
                                ...
                                <table class="table">
                                    <thead>
                                        <tr>
                                            ...
                                            <th class="col-md-8">SERVER ADDRESS</th>
                                            <th class="col-md-2">
                                    ...
                                    <tbody>
                                        <tr ng-repeat="obj in recordList">
                                            <td class="col-md-2">{{obj.SERVER_NAME}}</td>
                                            <td class="col-md-8">{{obj.SERVER_ADDRESS}}</td>
                                            <td class="col-md-2">
